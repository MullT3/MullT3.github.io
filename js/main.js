...
$(document).ready(function () {
  ...
  // Apply same behaviour to BOTH buttons
  $('a.blog-button, a.projects-button').click(function (e) {
    collapsePanel();
  });
  ...
  $('.navigation-wrapper .blog-button, .navigation-wrapper .projects-button').click(function () {
